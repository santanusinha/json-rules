...
public class ExistentialInExpression extends JsonPathBasedExpression {
    private List<Object> values;

    public ExistentialInExpression() { super(ExpressionType.exist_in); }

    @Builder
    public ExistentialInExpression(String path, @Singular List<Object> values, PreOperation<?> preoperation) {
        super(ExpressionType.exist_in, path, preoperation);
        this.values = values;
    }
    @Override
